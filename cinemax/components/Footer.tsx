    ...
    <footer className="flex flex-col w-full items-center justify-center bg-gray-800/45">
      ...
      <div className="flex w-full px-64 gap-24 justify-center">
        ...
        <h1 className="uppercase font-bold mb-4">Nasza aplikacja</h1>
          ...
          <Image src="/App-Store.png" width={153.75} height={45.675} alt="Pobierz aplikację na App Store"/>
          </Link>
          <Link href="https://play.google.com/store/" target="_blank">
          <Image src="/Google-Play.png" width={153.75} height={45.675} alt="Pobierz aplikację na Google Play"/>
          </Link>
          </div>
        </div>
      </div>
